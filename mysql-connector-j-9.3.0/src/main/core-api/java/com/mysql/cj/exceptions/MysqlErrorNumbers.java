...
public final class MysqlErrorNumbers {
    ...
    public final static int ER_RPL_REPO_HAS_GAPS = 10032; // [HY000] It is not possible to change the type of the relay log's main.java.com.example.survey.repository because there are wo...
    ...
    public final static int ER_RPL_REPLICA_CANT_FLUSH_CONNECTION_METADATA_REPOS = 10552; // [HY000] Failed to flush connection metadata main.java.com.example.survey.repository.
    ...
    public final static int ER_RPL_SSL_INFO_IN_CONNECTION_METADATA_IGNORED = 10730; // [HY000] SSL information in the connection metadata main.java.com.example.survey.repository are igno...
    ...
    public final static int ER_GRP_RPL_APPLIER_METADATA_REPO_MUST_BE_TABLE = 11679; // [HY000] Applier metadata main.java.com.example.survey.repository must be set to TABLE
    ...
    public final static int ER_GRP_RPL_CONNECTION_METADATA_REPO_MUST_BE_TABLE = 11680; // [HY000] Connection metadata main.java.com.example.survey.repository must be set to TABLE.
    ...
    public final static int ER_SERVER_REPLICA_AM_INIT_REPOSITORY = 13124; // [HY000] Replica failed to initialize applier metadata structure from the main.java.com.example.survey.repository
    ...
    public final static int ER_WARN_WRONG_COMPRESSION_ALGORITHM_LOG = 13488; // [HY000] Invalid SOURCE_COMPRESSION_ALGORITHMS '%s' found in main.java.com.example.survey.repository for ch...
    public final static int ER_WARN_WRONG_COMPRESSION_LEVEL_LOG = 13489; // [HY000] Invalid SOURCE_ZSTD_COMPRESSION_LEVEL found in main.java.com.example.survey.repository for channel '%s...
    ...
    public final static int ER_CHANGE_RPL_INFO_REPOSITORY_FAILURE = 1750; // [HY000] Failure while changing the type of replication main.java.com.example.survey.repository: %s.
    ...
    public final static int ER_REPLICA_CM_INIT_REPOSITORY = 1871; // [HY000] Replica failed to initialize connection metadata structure from the main.java.com.example.survey.repository
    public final static int ER_REPLICA_AM_INIT_REPOSITORY = 1872; // [HY000] Replica failed to initialize applier metadata structure from the main.java.com.example.survey.repository
    ...
    public final static int ER_REPLICA_NEW_CHANNEL_WRONG_REPOSITORY = 3077; // [HY000] To have multiple channels, main.java.com.example.survey.repository cannot be of type FILE; Please c...
